...
import { CashOutInputDto } from "../CashOutInputDto";
import { BetDto } from "../BetDto";
import { PlaceBetInputDto } from "../PlaceBetInputDto";
...
export class BetServiceBase {
  ...
  async CashOut(args: CashOutInputDto): Promise<BetDto> {
    throw new Error("Not implemented");
  }
  async PlaceBet(args: PlaceBetInputDto): Promise<BetDto> {
    throw new Error("Not implemented");
  }
}
